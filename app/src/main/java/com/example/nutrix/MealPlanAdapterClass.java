...
public class MealPlanAdapterClass extends RecyclerView.Adapter<MealPlanAdapterClass.ViewHolder> {

    RecipeHelperClass[] recipearray;
    Context context;

    public MealPlanAdapterClass(RecipeHelperClass[] recipearray, Context activity){
